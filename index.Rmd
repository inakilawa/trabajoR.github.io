...
```{r aov, eval=FALSE, warning=FALSE, include=FALSE}
...
```{r dtg, eval=FALSE, warning=FALSE, include=FALSE}
...
```{r leyt, eval=FALSE, warning=FALSE, include=FALSE}
neigh = "Leyton"
